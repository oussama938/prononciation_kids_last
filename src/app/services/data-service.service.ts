...
export class DataService {
  public unites: Unite[] = [
    new Unite(
      1,
      [
        'fier', 'arbre', 'jardin', 'Zina', 'Elyssa', 'papa', 'maman', 'lapin', 'la lune', 'la table', 'le', 'elle', 'lit', 'merci', 'l oncle Emile', 'Un joli oiseau', 'Amira', 'mamie', 'Mourad', 'ma mère', 'Amine mon frère', 'ma soeur', 'tonton', 'il', 'papi','fleur','soleil','chaise','chat','étoile'
      ],
      [
